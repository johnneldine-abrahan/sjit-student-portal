    ...
    <Router>
      <Routes>
        ...
        <Route
          ...
          element={<Admin_Enroll_Students />}
        />
        <Route
          path="/admin/confirm-enrollment"
          element={<Admin_ConfirmEnrollment />}
        />
        <Route
          path="/admin/faculty-members"
          element={<Admin_FacultyMembers />}
        />
        <Route
          path="/admin/manage-schedule"
          element={<Admin_ManageSchedule />}
        />
        <Route
          path="/admin/manage-accounts"
          element={<Admin_ManageAccounts />}
        />
        ...
        <Route
          ...
          element={<Registrar_Students />}
        />
        <Route
          path="/registrar/enroll-students"
          element={<Registrar_Enroll_Students />}
        />
        <Route
          path="/registrar/confirm-enrollment"
          element={<Registrar_ConfirmEnrollment />}
        />
        <Route path="/registrar/archive" element={<Registrar_Archive />} />
        <Route path="/finance/dashboard" element={<Finance_Dashboard />} />
        <Route
          path="finance/enrollment-queue"
          element={<Finance_EnrollmentQueue />}
        />
        <Route
          path="/finance/tag-liabilities"
          element={<Finance_TagLiabilities />}
        />
        <Route
          path="/finance/student-records"
          element={<Finance_StudentRecords />}
        />
